        ...
        if (file) {
            ...
            reader.onload = function(event) {
                ...
                try {
                    ...
                    // ローカルストレージがいっぱいになった場合の対策
                    alert("ローカルストレージの容量制限を超えました。高解像度すぎる画像、または投稿数が多すぎる可能性があります。一度いくつかの投稿を削除するか、容量の小さな画像でお試しください。");
                    locationData.pop(); // 追加に失敗したデータを戻す
                }
            };
